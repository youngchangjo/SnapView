...
- Install package: open the latest release page and download `SnapView-0.9.18.dmg`
...
- 설치 파일: 최신 릴리즈 페이지에서 `SnapView-0.9.18.dmg`를 다운로드해 설치합니다
